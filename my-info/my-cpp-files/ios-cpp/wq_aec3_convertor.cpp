...
int WqAec3Convertor::convertCleanAudioToWAVBytes(const std::vector<std::vector<uint8_t>>& audioFramesBytes,
                                                int inputSampleRate,
                                                uint8_t** outputWavData,
                                                size_t* outputSize,
                                                int outputSampleRate) {
    // This method is a wrapper around convertCleanAudioToWAV for compatibility
    return convertCleanAudioToWAV(audioFramesBytes, inputSampleRate, outputWavData, outputSize, outputSampleRate);
}
